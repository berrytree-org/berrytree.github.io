...
{{< breadcrumb trail="Home|/|Ancestors|/ancestors/|Family Lines|/family-lines/|Mary Berry (Elizabeth's Daughter)" >}}

{{< ancestor-chain gen3="Elizabeth Berry (unwed) × William Riley" loc3="Orange County, North Carolina" link3="/ancestors/elizabeth-berry/" />}}

{{< ancestor-profile
  name="Mary Berry"
  gen="4"
  born="c. 1792, Orange County, North Carolina"
  died="Unknown, Person County, North Carolina"
  spouse="Thomas Berry (married March 7, 1809)"
  parents="Elizabeth Berry and William Riley, Orange County, NC"
>}}
...
**September 23, 2008 Updated 10/19/2015**

---

<h2 class="ancestor-section">Census Records</h2>

{{< census-summary summary="Mary Berry was 18 years old in the 1810 Person County NC Census." >}}

- **1810** — Mary Berry listed in Person County NC Census
